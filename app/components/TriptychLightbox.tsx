      ...
      <div className="grid w-full grid-cols-3 gap-1 bg-transparent sm:gap-2">
        {items.map((item, i) => (
          <button
            ...
            className="relative aspect-[16/10] w-full min-w-0 cursor-zoom-in overflow-hidden bg-transparent shadow-none outline-none focus-visible:ring-2 focus-visible:ring-black/25 focus-visible:ring-offset-2 focus-visible:ring-offset-[#F4F2EE]"
