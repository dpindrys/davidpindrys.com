      ...
      <div className="flex w-full flex-col gap-2 md:gap-5 lg:gap-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5 w-full items-stretch">
          <a
            ...
            className="flex flex-col rounded-2xl border-2 border-[#005077] bg-white p-5 md:p-6 min-h-0 h-full text-left no-underline shadow-none hover:opacity-80 transition-opacity focus:outline-none focus-visible:ring-2 focus-visible:ring-black/20 focus-visible:ring-offset-2 focus-visible:ring-offset-[#F4F2EE]"
          >
