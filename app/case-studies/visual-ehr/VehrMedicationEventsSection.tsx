    ...
    <article aria-labelledby="vehr-medication-events-heading">
      <div className={frxSectionIntroStackClass}>
        ...
        <p className={frxSectionBodyClass}>
          ...
          events on the shared timeline—not static list items. On Sep 09,
          metformin proves insufficient and insulin begins; by Sep 14, dosing
          and glycemic control align with the same columns used for labs and
          encounters.
        </p>
      </div>
